...
const Blogs = () => {
    return (
        <div>
            <div className="blog-container max-w-7xl mx-auto py-24 text-white">
                <div className='px-0 md:px-16 w-10/12  md:w-8/12 mx-auto'>
                    <div className="bg-emerald-400 p-5 rounded mb-20 shadow-lg">
                        <h1 className='w-full bg-gray-500 p-2 text-white text-xl font-mono rounded shadow-lg mb-4'>Difference between authorization and authentication?</h1>
                    ...
                    <div className="bg-emerald-400 p-5 rounded  shadow-lg mb-20">
                        <h1 className='w-full bg-gray-500 p-2 text-white text-xl font-mono rounded shadow-lg mb-4'>Why are you using firebase? What other options do you have to implement authentication?</h1>
                    ...
                    <div className="bg-emerald-400 p-5 rounded  shadow-lg">
                        <h1 className='w-full bg-gray-500 p-2 text-white text-xl font-mono rounded shadow-lg mb-4'>What other services does firebase provide other than authentication?</h1>
                        <p>
                            <div className="flex w-10/12 items-center justify-between mx-auto">
                                <div className='text-left'>
